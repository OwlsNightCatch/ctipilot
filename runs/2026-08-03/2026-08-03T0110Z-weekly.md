...
bridge_uses:
  ...
  - host: eur-lex.europa.eu
    ...
    covered_anyway: true
sources_changed:
  - "certvde: status candidate -> active (promotion bar met — state digest recorded 3 contributing runs)"
  ...
  - "last_successful_fetch refreshed for the sources that returned content this run"
entities_added: []
