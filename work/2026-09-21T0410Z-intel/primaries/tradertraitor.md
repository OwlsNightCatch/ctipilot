...
author: Albert Priego; Alex Delamotte; Matej Havranek
...
description: North Korean operators built a foothold on a DevOps engineer's Mac in a campaign whose job interview lures deliver malware via Terraform lock files.
sitename: SentinelOne
date: "2026-09-18"
---
## Executive Summary
...
| config | modules/config.rs | config <key> | 
