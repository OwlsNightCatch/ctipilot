...
- **`cti-verification`** — Phase 5.7 cold-reader verifier (**Opus default**). Scope: the run's new entries + run record. Read-only; looped fresh-spawn until CLEAN or 5-iteration cap. Finding categories F1–F18 incl. frontmatter⇔body agreement, priority calibration, Admiralty-classification drift, and action-item discipline.
