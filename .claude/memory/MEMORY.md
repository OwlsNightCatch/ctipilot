...
- [Source fetch blocks & primary-source substitutes](source-fetch-blocks.md) — kernel.org git now behind Anubis (use Ubuntu/Debian trackers as substitute primary); CISA 403s; JS-only recipe gaps
