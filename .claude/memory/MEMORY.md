...
- [Design system](design-system.md) — the site's visual language = the "CTI Pilot Design Modernization" Claude Design project; component classes + brandable surface (nav/hero/ai-bar copy, accent-rgb auto-derived); DOM/JS contract for the new shell + live timeline
