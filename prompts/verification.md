...
- [ ] **Phase 5.7 verification sub-agent ran ≥1 iteration (≥2 for a CLEAN publish)** covering both URL truth and editorial quality; confirmed CLEAN (two consecutive CLEAN verdicts, independent cold passes of the single verifier definition) within ≤8 iterations, or residuals / a `confirmation_waived` reason logged in the run record.
