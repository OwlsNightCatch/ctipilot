...
def main() -> int:
    ...
    # Engagement data is generated by .github/workflows/sync-engagement.yml.
    # It may not exist on first run — that's fine; the SPA degrades gracefully.
    eng_path = ROOT / "state" / "engagement.json"
    if eng_path.exists():
        (data_out / "engagement.json").write_text(eng_path.read_text())
