...
schema: 1
kind: incident
title: "Brevo: a stolen, hardcoded Cloudflare API key let an attacker inject ClickFix malware and a WordPress backdoor plugin via a CDN-edge Worker into up to 100,000 customer sites, defeating origin-side integrity checks"
...
summary: >
  ...
  clipboard-paste lure and a WordPress administrator-backdoor plugin to up to 100,000 sites
